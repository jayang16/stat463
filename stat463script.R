...
#                            method = "rgmwm")
desktop_estimate = estimate(SARIMA(ar = 0, i = 0, ma = 1, sar = 0, si = 0, sma = 3, s = 7), desktop_ts,
                            method = "mle")
#AIC = 8332.12
...
#                            method = "rgmwm")
beyonce_estimate = estimate(SARIMA(ar = 1, i = 0, ma = 0, sar = 0, si = 0, sma = 2, s = 9), beyonce_ts,
                            method = "mle")
#AIC = 666.70
...
#                            method = "rgmwm")
chomsky_estimate = estimate(SARIMA(ar = 3, i = 0, ma = 3, sar = 5, si = 0, sma = 1, s = 7), chomsky_ts,
                            method = "mle")
#AIC = 8253.39
...
#                          method = "rgmwm")
lazio_estimate = estimate(SARIMA(ar = 2, i = 0, ma = 1, sar = 0, si = 0, sma = 1, s = 7), lazio_ts,
                          method = "mle")
#AIC = 851.30
